...
schmprint(SCHM_FILE _scheme)
{
	...
	while ( idx < WEAPONS )
	{
		...
		_scheme.weapon_settings[idx].power, 9,
...
%s -i scheme.wsc -wnr0 10 -wnr1 4\n\
or\n\
%s --input scheme.wsc --ninja-rope-ammo 10 --ninja-rope-power 4\n",
...
version "SCHEMED_VERSION" (MEDVEDx64, "SCHEMED_DATE")\n");
    ...
    for(x = 1; x < argc; x++)
    {
        ...
        /* ========================================================================================================= */
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_BAZOOKA].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_HOMING_MISSILE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_MORTAR].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_GRENADE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_CLUSTER_BOMB].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_SKUNK].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_PETROL_BOMB].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_BANANA_BOMB].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_HANDGUN].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_SHOTGUN].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_UZI].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_MINIGUN].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_LONGBOW].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_AIRSTRIKE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_NAPALM_STRIKE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_MINE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_FIRE_PUNCH].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_DRAGON_BALL].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_KAMIKAZE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_PROD].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_BATTLE_AXE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_BLOWTORCH].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_PNEUMATIC_DRILL].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_GIRDER].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_NINJA_ROPE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_PARACHUTE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_BUNGEE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_TELEPORT].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_DYNAMITE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_SHEEP].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_BASEBALL_BAT].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_FLAME_THROWER].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_HOMING_PIGEON].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_MAD_COW].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_HOLY_HAND_GRENADE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_OLD_WOMAN].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_SHEEP_LAUNCHER].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_SUPER_SHEEP].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_MOLE_BOMB].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_JET_PACK].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_LOW_GRAVITY].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_LASER_SIGHT].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_FAST_WALK].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_INVISIBILITY].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_DAMAGE_X2].power = atoi(argv[x+1]); }
        ...
        /* ========================================================================================================= */
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_FREEZE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_SUPER_BANANA_BOMB].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_MINE_STRIKE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_GIRDER_STARTER_PACK].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_EARTHQUAKE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_SCALES_OF_JUSTICE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_MING_VASE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_MIKES_CARPET_BOMB].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_PATSYS_MAGIC_BULLET].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_INDIAN_NUCLEAR_TEST].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_SELECT_WORM].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_SALVATION_ARMY].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_MOLE_SQUADRON].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_MB_BOMB].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_CONCRETE_DONKEY].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_SUICIDE_BOMBER].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_SHEEP_STRIKE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_MAIL_STRIKE].power = atoi(argv[x+1]); }
            ...
            if(x<argc-1) scheme.weapon_settings[WEAPON_ARMAGEDDON].power = atoi(argv[x+1]); }
